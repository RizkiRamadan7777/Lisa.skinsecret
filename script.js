const products = [
  ...
  { id: 5, title: "Lisa Skin Secret - Body Lotion",        image: "https://i.imgur.com/jI9NpYP.png", category: "Kulit", shopeeUrl: "https://shopee.co.id/affiliate-link-lotion", tiktokUrl: "https://tiktok.com/@yourpage/video/102" },
];
        ...
        card.innerHTML = `
          ...
          <div class="card-content">
            ...
            <div class="card-buttons">
              <a href="${p.shopeeUrl}" target="_blank" class="card-button card-button-shopee">Link Shopee</a>
              <a href="${p.tiktokUrl}" target="_blank" class="card-button card-button-tiktok">Link TikTok</a>
            </div>
          </div>
        `;
